# esphome-anenji-4.2
Конфигурация ESPHome для контроля и управления инвертором Anenji 4.2Kw 
ESPHome configuration to monitor and control a Anenji 4.2kW inverter 
[Original project](https://github.com/syssi/esphome-smg-ii)
Fork: https://github.com/janas-karol/esphome-anenji-6.2kw
## Поддерживаемая модели:
## Supported devices:
* Anenji 4.2kW
* Anenji 6.2kW
## Необходимо
...
* Generic ESP8266 Wemos D1 mini

## Schematics
* Необходимо снять родной модуль с портом RS485 и wifi(Можно акуратно открутить болтики которыми плата крепится не разбирая основной корпус)
* Выпаять родной модуль WiFi и подпаять проводки к пинам на плате. Пины питания и Rx Tx на родном модуле указаны.

<a href="https://raw.githubusercontent.com/Disperion/esphome-anenji-4.2kw/main/images/007.jpg" target="_blank">
<img src="https://raw.githubusercontent.com/Disperion/esphome-anenji-4.2kw/main/images/007.jpg" height="172">
</a>
  
<a href="https://raw.githubusercontent.com/Disperion/esphome-anenji-4.2kw/main/images/006.jpg" target="_blank">
<img src="https://raw.githubusercontent.com/Disperion/esphome-anenji-4.2kw/main/images/006.jpg" height="172">
</a>
...
Создайте устройство в ESPHome на ESP8266 и используйте содержимое файла `anenji_4kw.yaml` для создания конфигурации.
...
## References
* https://github.com/janas-karol/esphome-anenji-6.2kw
